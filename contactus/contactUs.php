    ...
    <div class="container">
        ...
        <div class="contact-wrapper">
           ...
           <div class="contact-info">
              ...
              <p><i class="fas fa-phone"></i> +383 49 393 360</p>
              <p><i class="fas fa-envelope"></i>swisstravel@hotmail.com</p>
              <p><i class="fas fa-map-marker-alt"></i>Rruga Vëllëzërit Gërvalla, Pejë</p>
           </div>
        </div>
    </div>
 </section>
